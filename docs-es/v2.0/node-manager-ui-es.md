...
- Los gráficos por dispositivo de `Throughput`, `Retransmits`, `RTT Histogram` y `Ping Time Histogram` usan estilos de ejes, leyenda y tooltips alineados con el Circuit page, en lugar del antiguo cromado gris genérico del dashboard.
