...
## Who is LibreQoS for?
This software is intended for small Internet Service Providers. Internet Service Providers with more than 1000 subscribers may benefit more from using commercially supported alternatives with better NMS/CRM integrations such as <a href="https://preseem.com/">Preseem</a> or <a href="https://www.saisei.com/">Saisei</a>. Individuals wanting to reduce bufferbloat or latency on their home internet connections may want to try a home router supporting fq_codel, such as Ubiquiti's EdgeRouter-X (must enable advanced queue fq_codel).
