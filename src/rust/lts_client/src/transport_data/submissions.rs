...
pub struct UispExtDevice {
    ...
    pub tx_power: i64,
    pub rx_signal: i64,
    pub downlink_capacity_mbps: i64,
    pub uplink_capacity_mbps: i64,
    pub noise_floor: i64,
    pub mode: String,
...
impl From<Device> for UispExtDevice {
    fn from(d: Device) -> Self {
        ...
        Self {
            ...
            tx_power,
            rx_signal,
            downlink_capacity_mbps: downlink_capacity_mbps as i64,
            uplink_capacity_mbps: uplink_capacity_mbps as i64,
            noise_floor,
            mode,
            interfaces: iflist,
        }
