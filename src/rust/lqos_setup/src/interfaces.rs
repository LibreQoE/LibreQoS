...
use cursive::{view::Resizable, views::{Dialog, LinearLayout, RadioButton, RadioGroup, TextView}, Cursive};
...
fn build_interface_list(interfaces: &[String], group: &mut RadioGroup<String>, active: String) -> Vec<RadioButton<String>> {
